...
Пару лет назад я потерял доступ к аккаунту Facebook. Второй фактор был основан на SMS — сообщения от Facebook на мой российский номер перестали доходить. Можно было восстановить доступ через поддержку — прислать селфи с паспортом. Но я тогда засомневался, стоит ли оно того.
...
В корпоративной среде всем этим занимаются специально обученные люди. Они разграничивают доступ, учитывают угрозы, считают риски со стороны провайдера. Под это выделены бюджеты, налажены процессы, есть ответственность. Риски для компании вполне осязаемы — деньги и репутация.
