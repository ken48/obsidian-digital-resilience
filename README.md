...
В ежедневной работе пароли берутся из менеджера, а TOTP-коды — из аутентификатора. Для восстановления экспорт менеджера вместе с TOTP-секретами и кодами восстановления хранится в зашифрованном архиве секретов, который входит в резервную копию. А пароли и коды, необходимые для  самого восстановления, вынесены за пределы этой системы — на бумагу и в память.
